...
**Goals**: This project is divided into two main parts:

3D Gaussian Splatting:

- Implementation of a 3D Gaussian rasterization pipeline.
- Rendering pre-trained 3D Gaussians.
- Training code to optimize 3D Gaussians for custom scenes.
